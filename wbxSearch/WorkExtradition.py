...
class WorkExtradition:
    ...
    def _param_search(self, param: str,
        ...
        :param value_params: значение(или лист значений) параметра по которому ищем
    ...
    def search_query_search(self,
                            search_query: str | list,
                            complete_match: bool = True,
                            contains: bool = False) -> list:
        """
        ищем записи по 1 столбцу в выдачах
        :param search_query: наименование search_query по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def search_preset_id(self,
                         preset_id: str | list,
                         complete_match: bool = True,
                         contains: bool = False) -> list:
        """
        ищем записи по 2 столбцу в выдачах
        :param preset_id: наименование preset_id по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def kind_search(self,
                    kind: str | list,
                    complete_match: bool = True,
                    contains: bool = False) -> list:
        """
        ищем записи по 4 столбцу в выдачах
        :param kind: наименование kind по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def parent_search(self,
        ...
        :param parent: наименование parent по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def miner_search(self,
                     miner: str | list,
                     complete_match: bool = True,
                     contains: bool = False) -> list:
        """
        ищем записи по 6 столбцу в выдачах
        :param miner: наименование parent по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def miners_args_search(self,
                           miners_args: str | list,
                           complete_match: bool = True,
                           contains: bool = False) -> list:
        """
        ищем записи по 7 столбцу в выдачах
        :param miners_args: наименование parent по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def shard_kind_search(self, shard_kind: str | list,
                          complete_match: bool = True,
                          contains: bool = False) -> list:
        """
        ищем записи по 8 столбцу в выдачах
        :param shard_kind: наименование parent по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def query_search(self, query: str | list,
        ...
        :param query: наименование parent по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
    ...
    def category_search(self,
        ...
        :param category: наименование parent по которому ищем(можно передавать несколько значений листом)
        :param complete_match: полное совпадение
