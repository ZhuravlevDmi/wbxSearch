...
class SearchPresetIDTest(TestCase):
    ...
    def test_default_search_preset_id(self):
        ...
        self.assertEqual(res_list, result_default_search_preset_id)
    ...
    def test_complete_match_false_search_preset_id(self):
        ...
        self.assertEqual(res_list, result_complete_match_false_search_preset_id)
    ...
    def test_contains_true_search_preset_id(self):
        ...
        self.assertEqual(res_list, result_contains_true_search_preset_id)
    ...
    def test_contains_true_complete_match_false_search_preset_id(self):
        ...
        self.assertEqual(res_list, result_contains_true_complete_match_false_search_preset_id)
